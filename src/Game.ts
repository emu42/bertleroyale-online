...
const CardTypeProperies = new Map([
  ...
  [BertleRoyaleCardTypes.SHARKBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Sharkbert',
  ...
  [BertleRoyaleCardTypes.BERTXODIA,
    <BertleRoyaleCardTypeProperties> ({name: 'Bertxodia',
  ...
  [BertleRoyaleCardTypes.PIXELBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Pixelbert',
  ...
  [BertleRoyaleCardTypes.HACKERBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Hackerbert',
  ...
  [BertleRoyaleCardTypes.BERTENDER,
    <BertleRoyaleCardTypeProperties> ({name: 'Bertender',
  ...
  [BertleRoyaleCardTypes.GAMEBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Gamebert',
  ...
  [BertleRoyaleCardTypes.SNEAKYBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Sneakybert',
  ...
  [BertleRoyaleCardTypes.BILLBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Billbert',
  ...
  [BertleRoyaleCardTypes.MINEBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Minebert',
  ...
  [BertleRoyaleCardTypes.ANGRYBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Angrybert',
  ...
  [BertleRoyaleCardTypes.SCAMBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Scambert',
  ...
  [BertleRoyaleCardTypes.FROGBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Frogbert',
  ...
  [BertleRoyaleCardTypes.PLUMBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Plumbert',
  ...
  [BertleRoyaleCardTypes.TBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'T-Bert',
  ...
  [BertleRoyaleCardTypes.DRAGONBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Dragonbert',
  ...
  [BertleRoyaleCardTypes.EVILBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Evilbert',
  ...
  [BertleRoyaleCardTypes.BIRTHDAYBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Birthdaybert',
  ...
  [BertleRoyaleCardTypes.BOSSBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Bossbert',
  ...
  [BertleRoyaleCardTypes.LEECHBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Leechbert',
  ...
  [BertleRoyaleCardTypes.DAGOBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Dagobert',
  ...
  [BertleRoyaleCardTypes.SUSBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Susbert',
  ...
  [BertleRoyaleCardTypes.STONKSBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Stonksbert',
  ...
  [BertleRoyaleCardTypes.HOTBERTATO,
    <BertleRoyaleCardTypeProperties> ({name: 'Hot Bert-ato',
  ...
  [BertleRoyaleCardTypes.SANTABERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Santabert',
  ...
  [BertleRoyaleCardTypes.SPLASHBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Splashbert',
  ...
  [BertleRoyaleCardTypes.SADBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Sadbert',
  ...
  [BertleRoyaleCardTypes.MARXBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Marxbert',
  ...
  [BertleRoyaleCardTypes.LOVEBERT,
    <BertleRoyaleCardTypeProperties> ({name: 'Lovebert',
